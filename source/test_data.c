...
int testCreate()
{
    ...
    result = result && ((strcmp(data->data, "1234567890a") == 0) && (data->datasize == 1024));
...
int testCreate2()
{
    ...
    result = result && ((strcmp(data->data, data_s) == 0) && (data->datasize == data_size));
...
int testDup()
{
    ...
    result = result && (data->data != data2->data) && (data->datasize == data2->datasize) &&
...
int testReplace()
{
    ...
    result = result && ((strcmp(data->data, data_s2) == 0) && (data->datasize == data_size2));
